...
const AdminPaymentLogsPage = lazy(lazyWithRetry(() => import('./pages/admin/AdminPaymentLogsPage'), 'mansion-lazy-retry:admin-payment-logs'));
      ...
      >
        ...
        <Routes location={backgroundLocation || location}>
          ...
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="pagos" element={<AdminPaymentLogsPage />} />
