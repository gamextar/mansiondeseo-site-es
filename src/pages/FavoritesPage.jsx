...
export default function FavoritesPage() {
  ...
  return (
    <div className="min-h-mobile-browser-screen bg-mansion-base pb-mobile-legacy-nav pt-[calc(var(--safe-top)+80px)] lg:pb-10 lg:pt-20">
      <div className="mx-auto max-w-[88rem] px-[5vw] lg:px-[4vw]">
