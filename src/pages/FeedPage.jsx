...
export default function FeedPage() {
  ...
  const storiesRailClassName = `flex overflow-x-auto scrollbar-hide pb-2 select-none ${isDesktopViewport ? 'cursor-grab active:cursor-grabbing' : ''}`;
  const storiesRailStyle = {
    scrollbarWidth: 'none',
  ...
  return (
    <div className="min-h-screen bg-mansion-base pb-24 lg:pb-8 pt-navbar">
      ...
      >
        ...
        {isDesktopViewport ? (
          <ScrollContainer
            innerRef={storiesScrollRef}
            className={storiesRailClassName}
            style={storiesRailStyle}
            horizontal
            vertical={false}
