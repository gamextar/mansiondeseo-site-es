...
import { STORY_FEED_CACHE_INVALIDATED_EVENT, getProfiles, getProfilesVersion, getStories, getStorySnapshotRail, getToken } from '../lib/api';
...
const STORY_RAIL_REFRESH_INTERVAL_MS = 10 * 60_000;
...
export default function FeedPage({ initialData }) {
  ...
  const loadHomeStories = useCallback(async ({ syncBootstrap = false, fresh = false } = {}) => {
    ...
    try {
      const snapshotData = await getStorySnapshotRail({
        limit: resolvedLimit,
