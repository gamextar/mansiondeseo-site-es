      ...
      <div className="px-4 lg:px-8 pt-4 lg:pt-6 max-w-2xl lg:mx-auto">
        ...
        <div className="text-center mb-6">
          <div className="relative inline-block">
            ...
            <button className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-mansion-crimson text-white flex items-center justify-center">
              <Camera className="w-4 h-4" />
            </button>
          </div>

          <h2 className="font-display text-xl font-bold text-text-primary mt-4">Tu Perfil</h2>
