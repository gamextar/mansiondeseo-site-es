            ...
            <div className="bg-mansion-card rounded-2xl p-4 border border-mansion-gold/20 space-y-4">
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-text-dim">Actualiza last_active solo en usuarios fake activos/verificados, priorizando destacados/feed priority. Recomendado: 36 por hora.</p>
                </div>
                <button
