  ...
  return (
    <div className="min-h-screen bg-mansion-base text-text-primary flex flex-col items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="relative w-full max-w-lg z-10">
        ...
        {/* ENCODING step — NO AnimatePresence, NO framer-motion, zero overhead during FFmpeg */}
        {step === 'encoding' && (
      ...
      {step === 'encoding' && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-4 rounded-2xl bg-black/90 border border-white/10 shadow-2xl">
